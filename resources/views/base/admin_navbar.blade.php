        ...
        <ul class="space-y-8">
            ...
            <li>
                ...
                <ul id="jadwalDropdown" class="ml-8 mt-4 space-y-4 hidden">
                    <li><a href="{{ route('jadwal_misa') }}" class="block text-[#f6f1e3] hover:text-[#ae0001]">Jadwal Misa</a></li>
            ...
            <li>
                ...
                <ul id="pengurusDropdown" class="ml-8 mt-4 space-y-4 hidden">
                    ...
                    <li><a href="{{route('templates.index')}}" class="block text-[#f6f1e3] hover:text-[#ae0001]">Dokumen</a></li>
                </ul>
            </li>
            <li>
